      ...
      <div className="row">
        <div className="col-sm-3 filter-pane">
          <div className="d-flex mb-3">
            <div className="me-auto p-2 font-strong">
          ...
          <div class="d-flex flex-column mt-3">
            ...
            <div class="p-2">
              <input
                ...
                className="me-2"
              />
              <label for="vehicle1"> Fiction</label>
              <br />
            </div>
            <div class="p-2">
              <input
                ...
                value="Car"
              />
              <label for="vehicle2"> Non-fiction</label>
              <br></br>
            </div>
          </div>
          ...
          <div className="row">
            <div className="col">
              ...
              <p>
                ...
                <span className="products-num ms-3">
                  {" "}
                  ( Showing 20 products ){" "}
                </span>
              </p>
